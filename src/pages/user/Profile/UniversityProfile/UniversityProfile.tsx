...
const universitySchema = z.object({
  ...
  student_card_front: z.union([z.string(), z.object({}).passthrough(), z.null()]).optional(),
  student_card_back: z.union([z.string(), z.object({}).passthrough(), z.null()]).optional(),
});
...
const UniversityProfile = () => {
  ...
  const handleConfirmUpdate = async () => {
    ...
    try {
      console.log('🚀 UniversityProfile - Starting update with data:', watchedValues);
