...
import { universities, faculties } from "@/constants/universityProfile";
...
const UniversityProfile = () => {
  ...
  const {
    ...
    defaultValues: {
      ...
      year_of_study: Number(student?.year_of_study) || 1, // Ensure it's a number
  ...
  // ✅ Temporarily disable this useEffect to prevent infinite loop
  // useEffect(() => {
  //   if (
  //     watchedValues.student_card_front &&
  //     watchedValues.student_card_back &&
  //     student?.student_id // Only reset if we have student data
  //   ) {
  //     reset({
  //       ...student,
  ...
  //   watchedValues.student_card_back,
  //   watchedValues.student_card_front,
  //   student?.student_id, // Only depend on student_id instead of whole student object
  // ]);
    ...
    async (imageUrl: string | null, file?: File) => {
      ...
      if (file && side === "student_card_front") {
        try {
          ...
          if (ocrData) {
            ...
            if (ocrData.university_name) {
              ...
              const foundUniversity = universities.find(
                (uni) => uni.name === ocrData.university_name,
              );
              ...
              if (foundUniversity) {
                ...
                console.log(
                  "Không tìm thấy trường phù hợp trong danh sách:",
          ...
          alert(
            "Lỗi khi xử lý OCR thẻ sinh viên. Vui lòng thử lại với ảnh khác.",
          );
        } finally {
  ...
  const onSubmit = async (formData: any) => {
    console.log("🎯 onSubmit function called with validated data!");
  ...
  const handleConfirmUpdate = async () => {
    ...
    try {
      console.log(
        "🚀 UniversityProfile - Starting update with data:",
        watchedValues,
      );
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-sm text-blue-700 dark:text-blue-300">
                    ...
                    <ul className="space-y-1 text-xs">
                      ...
                      <li>
                        • Đảm bảo ánh sáng đủ, không bị mờ hoặc phản quang
                      </li>
                      <li>
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div className="relative">
                  <ImageUpload
                    ...
                    selectedImage={
                      typeof watchedValues.student_card_front === "string"
                        ? watchedValues.student_card_front
                        : null
                    }
                ...
                <ImageUpload
                  ...
                  selectedImage={
                    typeof watchedValues.student_card_back === "string"
                      ? watchedValues.student_card_back
                      : null
                  }
                  setIsProcessing={handleProcessStudentCard}
              ...
              <div className="space-y-8 p-6">
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                  ...
                  <FormField
                    ...
                    error={
                      errors.class_id
                        ? { message: errors.class_id.message ?? "" }
                        : undefined
                    }
                    theme="university"
                  >
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                  ...
                  <FormField
                    ...
                    error={
                      errors.year_of_study
                        ? { message: errors.year_of_study.message ?? "" }
                        : undefined
                    }
                    required
                    theme="university"
                  ...
                  <div className="lg:col-span-2">
                    <FormField
                      ...
                      error={
                        errors.major_name
                          ? { message: errors.major_name.message ?? "" }
                          : undefined
                      }
                      required
                      theme="university"
