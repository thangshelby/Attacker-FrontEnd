      ...
      <div className="space-y-8 p-6">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Hồ sơ vay của bạn đã được gửi thành công. Bạn có thể in tài liệu hồ
            sơ để lưu trữ.
          </p>
        </div>
        ...
        <div className="rounded-xl border border-blue-200 bg-blue-50 p-6 dark:border-blue-800 dark:bg-blue-900/20">
          ...
          <p className="mb-6 text-sm text-blue-700 dark:text-blue-300">
            Tải xuống và in hồ sơ vay của bạn để lưu trữ thông tin chi tiết về
            khoản vay.
          </p>
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <button
              ...
              disabled={isPrinting}
              className="flex items-center justify-center rounded-xl bg-blue-600 px-6 py-3 font-semibold text-white shadow-sm transition-all duration-200 hover:bg-blue-700 focus:ring-2 focus:ring-blue-500/50 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {isPrinting ? (
                <>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-purple-700 dark:text-purple-300">
                    Theo dõi trạng thái hồ sơ qua trang "Lịch sử vay" hoặc qua
                    email/SMS thông báo từ hệ thống.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:justify-center">
          ...
          <button
            onClick={() => navigate("/")}
            className="flex items-center justify-center rounded-xl border-2 border-gray-300 bg-white px-6 py-3 font-semibold text-gray-700 transition-all hover:border-gray-400 hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
          >
